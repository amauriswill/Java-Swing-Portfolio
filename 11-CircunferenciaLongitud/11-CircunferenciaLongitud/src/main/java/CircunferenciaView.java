...
public class CircunferenciaView extends JFrame {
    ...
    public CircunferenciaView() {
        // LookAndFeel omitido

        setTitle("Calculadora Geométrica Accesible");
        setSize(450, 500);
        ...
        JLabel lblInstruccion = new JLabel("Ingrese el Radio (r):");
        ...
        // BOTÓN ACCESIBLE
        btnCalcular = new JButton("CALCULAR LONGITUD");
    ...
    public void mostrarError(String mensaje) {
        JOptionPane.showMessageDialog(this, mensaje, "Error Geométrico", JOptionPane.ERROR_MESSAGE);
    }
}